...
{
    HavanaNoError               = PLAYER_NO_ERROR,
    HavanaNotOpen               = PLAYER_NOT_OPEN,
    HavanaNoDevice              = PLAYER_NO_DEVICE,
    HavanaNoMemory              = PLAYER_NO_MEMORY,
    HavanaPlaybackInvalid       = PLAYER_PLAYBACK_INVALID,
    HavanaPlaybackAlreadyExists = PLAYER_PLAYBACK_ALREADY_EXISTS,
    HavanaPlaybackActive        = PLAYER_PLAYBACK_ACTIVE,
    HavanaTooManyPlaybacks      = PLAYER_TOO_MANY_PLAYBACKS,
    HavanaDemuxInvalid          = PLAYER_DEMUX_INVALID,
    HavanaStreamIncomplete      = PLAYER_STREAM_INCOMPLETE,
    HavanaStreamInvalid         = PLAYER_STREAM_INVALID,
    HavanaStreamAlreadyExists   = PLAYER_STREAM_ALREADY_EXISTS,
    HavanaTooManyStreams        = PLAYER_TOO_MANY_STREAMS,
    HavanaNoFactory             = PLAYER_NO_FACTORY,
    HavanaComponentInvalid      = PLAYER_COMPONENT_INVALID,
    HavanaError                 = PLAYER_ERROR
} HavanaStatus_t;
