                                ...
                                union attribute_descriptor_u*   Value)
{
    ...
    Result = PLAYER_ERRNO (PlayerInterface->Ops->component_get_attribute (Component, Attribute, Value));
    if (Result < 0)
                                ...
                                union attribute_descriptor_u*   Value)
{
    ...
    Result = PLAYER_ERRNO (PlayerInterface->Ops->component_set_attribute (Component, Attribute, Value));
    if (Result < 0)
