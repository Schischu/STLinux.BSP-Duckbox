...
struct player_interface_operations
{
    ...
    player_status_t (*component_get_attribute)  (player_component_handle_t       Component,
                                               const char*                     Attribute,
                                               union attribute_descriptor_u*   Value);
    player_status_t (*component_set_attribute)  (player_component_handle_t       Component,
                                               const char*                     Attribute,
                                               union attribute_descriptor_u*   Value);
