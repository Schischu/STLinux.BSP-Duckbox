	...
	pm_message_t state)
{
	...
	DBGPRINT(RT_DEBUG_TRACE, ("===> rt3070_suspend()\n"));
	net_dev = pAd->net_dev;
	...
	struct usb_interface *intf)
{
	...
	DBGPRINT(RT_DEBUG_TRACE, ("===> rt3070_resume()\n"));
	...
	IN RTMP_ADAPTER **ppAd)
{
	...
	DBGPRINT(RT_DEBUG_TRACE, ("===>rt3070_probe()!\n"));
...
//RtmpDevInit=============================================
	...
	if (handle == NULL)
	{
		printk("rt3070_probe(): Allocate memory for os handle failed!\n");
		return -ENOMEM;
	}
