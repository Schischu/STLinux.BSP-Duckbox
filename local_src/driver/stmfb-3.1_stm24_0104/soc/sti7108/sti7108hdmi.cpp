...
void CSTi7108HDMI::StartAudioClocks(void)
{
  ...
  if((val & SYS_CFG24_B4_N_RST) == 0)
  {
     ...
     *
     * Note that the reset bit is inverted compared with previous chips, sigh.
     */
  ...
  if((val & SYS_CFG24_B4_NPDA) == 0) {
    val |= SYS_CFG24_B4_NPDA;
    WriteSysCfg4Reg(SYS_CFG24_B4,val);
  }

  if((val & SYS_CFG24_B4_FS0_NSB) == 0 ||
     ReadSysCfg4Reg(SYS_CFG_B4_FS0_SDIV) == 0)
  {
    /*
     * Bring Fsynth0 (pcm0) out of digital standby
     */
    val |= SYS_CFG24_B4_FS0_NSB | SYS_CFG24_B4_FS0_SEL;
    WriteSysCfg4Reg(SYS_CFG24_B4,val);
  ...
  if((val & SYS_CFG24_B4_FS2_NSB) == 0 ||
     ReadSysCfg4Reg(SYS_CFG_B4_FS2_SDIV) == 0)
  {
    /*
     * Bring Fsynth2 (spdif) out of digital standby
     */
    val |= SYS_CFG24_B4_FS2_NSB | SYS_CFG24_B4_FS2_SEL;
    WriteSysCfg4Reg(SYS_CFG24_B4,val);
