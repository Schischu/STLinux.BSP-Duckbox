...
void CSTb7100VTG::GetVSyncPositions(int outputid, const stm_timing_params_t &TimingParams, ULONG *ulVDO, ULONG *ulVDS)
{
  ...
  if (((m_syncType[outputid] == STVTG_SYNC_TIMING_MODE) && TimingParams.VSyncPolarity) ||
      ((m_syncType[outputid] == STVTG_SYNC_INVERSE_TIMING_MODE) && !TimingParams.VSyncPolarity) ||
      (m_syncType[outputid] == STVTG_SYNC_POSITIVE))
  {
    /*
