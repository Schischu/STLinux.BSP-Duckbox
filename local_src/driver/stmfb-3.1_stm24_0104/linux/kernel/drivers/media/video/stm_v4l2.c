/***********************************************************************\
 *
 * File: linux/kernel/drivers/media/video/stm_v4l2.c
...
static int
stm_v4l2_open (struct file  *file)
{
...
static long
stm_v4l2_do_ioctl (struct file  *file,
		   unsigned int  cmd,
		   void         *arg)
{
...
static long
stm_v4l2_ioctl (struct file   *file,
		unsigned int   cmd,
		unsigned long  arg)
{
...
static struct v4l2_file_operations stm_v4l2_fops = {
  .owner   = THIS_MODULE,
  .open    = stm_v4l2_open,
