...
protected:
  ...
  bool StartNTG5(const stm_mode_line_t*);
...
private:
  bool SetDENCOutputFormat(ULONG);
  void SetHDDACOutputSyncsAndClocks(void);
  void SetHDDACUpsampler(ULONG);
  void SetHDDACOutputFormat(ULONG);
