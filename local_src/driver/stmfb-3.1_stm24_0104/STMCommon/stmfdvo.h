...
{
public:
  CSTmFDVOAWG (CDisplayDevice* pDev, ULONG ulRegOffset, const char *name);
...
{
public:
  CSTmFDVO(CDisplayDevice *, ULONG ulFDVOOffset, COutput *,const char *name = "fdvo0");
  virtual ~CSTmFDVO();
