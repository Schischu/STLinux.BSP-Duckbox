...
DRIVER_MULTICOM_URL		:= ftp://ftp.stlinux.com/pub/tools/products/multicom$(DRIVER_MULTICOM_MAJORVERSION)/R$(DRIVER_MULTICOM_VERSION)/stm-multicom.$(DRIVER_MULTICOM_SHORTVERSION)-$(DRIVER_MULTICOM_VERSION)-noarch.$(DRIVER_MULTICOM_SUFFIX)
