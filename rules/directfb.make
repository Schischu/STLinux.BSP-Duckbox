...
# Paths and names
#
DIRECTFB_VERSION	:= 1.4.11
DIRECTFB_MD5		:= 94735ccec21120794adcce93a61445d2
...
$(STATEDIR)/directfb.extract:
	...
	cd $(DIRECTFB_DIR) && [ -f configure ] || sh autogen.sh
	@$(call touch)
...
DIRECTFB_GFX-$(PTXCONF_DIRECTFB_GFX_STGFX)		+= stgfx
